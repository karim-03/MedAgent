...
COMPLETE_PATIENT_REVERSIBLE_DEFECT = {
    "age": 58, "sex": "man", "cp": 3, "trestbps": 145, "chol": 260,
    "fbs": "no", "restecg": 0, "thalach": 132, "exang": "yes",
    "oldpeak": 2.1, "slope": 1, "ca": 2, "thal": 3,  # thal=3 -> reversible defect
}
...
def test_shap_contributions_ground_thal_to_patients_actual_value_not_top_dummy():
    ...
    result = validate_patient_fields(COMPLETE_PATIENT_REVERSIBLE_DEFECT)
    prediction = predict(result.normalized_fields)
